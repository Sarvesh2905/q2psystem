...
await api.post("/discount",formData);
...
await api.put(`/discount/${selected.Sno}`,{
...
await api.patch(`/discount/toggle/${id}`);
...
<h5>
Masters / <span className="text-primary">Discount</span>
</h5>
...
<input
className="form-control"
value={selected.discount_name}
onChange={(e)=>
setSelected({...selected,discount_name:e.target.value})
}
/>
